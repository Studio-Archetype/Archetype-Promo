...
void main(){
	...
	if (albedo.a > 0.1){
		...
		float doRecolor = float((heldItemId  ==  89 || heldItemId   == 138 || heldItemId   == 169 ||
		                         heldItemId  == 213) && isMainHand > 0.5);
			  doRecolor+= float((heldItemId2 ==  89 || heldItemId2  == 138 || heldItemId2  == 169 ||
								 heldItemId2 == 213) && isMainHand < 0.5);
